    ...
    for await (const delta of streamAiChatCompletion(
      ...
      preparedDraft.userPrompt,
      {
        timeoutMs: readAiProviderNumber(
          ["AI_LETTER_POLISH_TIMEOUT_MS", "AI_LETTER_DRAFT_TIMEOUT_MS"],
          ["LM_STUDIO_AI_LETTER_POLISH_TIMEOUT_MS", "LM_STUDIO_AI_LETTER_DRAFT_TIMEOUT_MS"],
          240000
        ),
        maxTokens: readAiProviderNumber(
          ["AI_LETTER_POLISH_MAX_TOKENS", "AI_LETTER_DRAFT_MAX_TOKENS"],
          ["LM_STUDIO_AI_LETTER_POLISH_MAX_TOKENS", "LM_STUDIO_AI_LETTER_DRAFT_MAX_TOKENS"],
          1800
        ),
        temperature: readAiProviderNumber(
          ["AI_LETTER_POLISH_TEMPERATURE", "AI_LETTER_DRAFT_TEMPERATURE"],
          ["LM_STUDIO_AI_LETTER_POLISH_TEMPERATURE", "LM_STUDIO_AI_LETTER_DRAFT_TEMPERATURE"],
          0.25
        ),
      }
    )) {
